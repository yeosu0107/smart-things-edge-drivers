...
- [`bus-tts-api/`](bus-tts-api/) — 서울시 버스 도착 정보를 SmartThings 가상 디바이스 switch toggle로 트리거하고 갤럭시 홈 미니에서 TTS로 출력. SmartThings `API_ONLY` 앱(OAuth-In) + Cloudflare Workers + KV.
